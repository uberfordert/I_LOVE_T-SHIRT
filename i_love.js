...
imageSwitch.addEventListener("change", () => {
  if (imageSwitch.checked) {
    imageCenterToggle.src = "assets/i_love-black.png";
    interactiveText.style.color = "white";
    document.body.style.backgroundColor = "rgb(18, 18, 18)";
  } else {
    imageCenterToggle.src = "assets/i_love-white.png";
...
imageLinkToggle.addEventListener("mouseenter", () => {
  imageLinkToggle.src = "assets/2-back.png";
});

imageLinkToggle.addEventListener("mouseleave", () => {
  imageLinkToggle.src = "assets/1-back.png";
});

const buyButton = document.querySelector(".buy-button button");
buyButton.addEventListener("click", () => {
  window.open(
    "https://www.paypal.com/sdk/js?client-id=Adqe_kZLmfknC3FVKQ9rME3Rwa3q-99Y7OtNht9MY2UMRy_sp8owMH1r0GQ2GbSSOXR_xx-_GvrSa5Rq&currency=EUR",
    "_blank"
  );
});
